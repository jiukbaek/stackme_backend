    ...
    return function(el, data) {
      ...
      // No center wrapper has been found.
        ...
        image = el.find(function(child) {
          return (
            child.name === "img" &&
            CKEDITOR.tools.array.indexOf(["figure", "a"], child.parent.name) !==
              -1
          );
        }, true)[0];
    ...
    resizer.on("mousedown", function(evt) {
      ...
      function getMaxSize() {
        ...
        maxSize.width = Math.max(
          maxSize.width === "natural" ? natural.width : maxSize.width,
          min.width
        );
        maxSize.height = Math.max(
          maxSize.height === "natural" ? natural.height : maxSize.height,
          min.width
        );
